...
func TestEventMapping(t *testing.T) {
	...
	clusterManager := event["cluster_manager"].(mapstr.M)
	...
	fileSystem := event["filesystem"].(mapstr.M)
	...
	listenerManager := event["listener_manager"].(mapstr.M)
	...
	runtime := event["runtime"].(mapstr.M)
