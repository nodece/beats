...
func TestWritePs(t *testing.T) { //nolint: dupl //This is a test, we want it to be verbose
...
func TestReadPS(t *testing.T) { //nolint: dupl //This is a test, we want it to be verbose
...
func TestBlkioTotal(t *testing.T) { //nolint: dupl //This is a test, we want it to be verbose
