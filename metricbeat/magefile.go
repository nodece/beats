...
import (
	...
	_ "github.com/elastic/beats/v9/dev-tools/mage/kubernetes"
	...
	//mage:import
	_ "github.com/elastic/beats/v9/metricbeat/scripts/mage/target/metricset"
)
...
func MockedTests(ctx context.Context) error {
	...
	params.ExtraFlags = []string{"github.com/elastic/beats/v9/metricbeat/mb/testing/data/."}
