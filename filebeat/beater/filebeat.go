...
import (
	...
	_ "github.com/elastic/beats/v9/filebeat/include"
	...
	"github.com/elastic/beats/v9/filebeat/input/v2/compat"
	...
	_ "github.com/elastic/beats/v9/filebeat/processor/add_kubernetes_metadata"
	_ "github.com/elastic/beats/v9/libbeat/processors/decode_csv_fields"

	// include all filebeat specific autodiscover features
	_ "github.com/elastic/beats/v9/filebeat/autodiscover"
)
