...
import (
	...
	"github.com/elastic/beats/v9/x-pack/auditbeat/processors/sessionmd/provider/kerneltracingprovider"
	"github.com/elastic/beats/v9/x-pack/auditbeat/processors/sessionmd/provider/procfsprovider"
