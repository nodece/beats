...
import (
	...
	"github.com/elastic/beats/v9/x-pack/filebeat/input/entityanalytics/provider/azuread/authenticator/oauth2"
	"github.com/elastic/beats/v9/x-pack/filebeat/input/entityanalytics/provider/azuread/fetcher"
	"github.com/elastic/beats/v9/x-pack/filebeat/input/entityanalytics/provider/azuread/fetcher/graph"
