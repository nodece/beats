...
func TestUser_Merge(t *testing.T) {
	tests := map[string]struct {
		...
		"id-mismatch": {
			In:      &User{ID: uuid.Must(uuid.FromString("187f924c-e867-477e-8d74-dd762d6379dd"))},
			InOther: &User{ID: uuid.Must(uuid.FromString("80c3f9af-75ae-45f5-b22b-53f005d5880d"))},
			Want:    &User{ID: uuid.Must(uuid.FromString("187f924c-e867-477e-8d74-dd762d6379dd"))},
		},
		"ok": {
			In: &User{
