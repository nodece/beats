...
import (
	...
	"github.com/elastic/beats/v9/x-pack/osquerybeat/ext/osquery-extension/pkg/hostfs"
	"github.com/elastic/beats/v9/x-pack/osquerybeat/ext/osquery-extension/pkg/proc"
)
